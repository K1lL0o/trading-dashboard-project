        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white font-sans">
            ...
            <main className="max-w-7xl mx-auto px-6 py-6">
                ...
                <div className="mb-6 flex space-x-2 border-b border-gray-700">
                    <button onClick={() => setActiveTab('live')} className={`flex items-center space-x-2 px-4 py-2 font-medium border-b-2 ${activeTab === 'live' ? 'border-blue-400 text-white' : 'border-transparent text-gray-400'}`}>
                        <Clock size={18} /><span>Live Signal Monitor</span>
                    </button>
                    <button onClick={() => setActiveTab('backtest')} className={`flex items-center space-x-2 px-4 py-2 font-medium border-b-2 ${activeTab === 'backtest' ? 'border-blue-400 text-white' : 'border-transparent text-gray-400'}`}>
